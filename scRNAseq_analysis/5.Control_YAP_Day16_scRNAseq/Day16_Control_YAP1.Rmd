...
Day16_Control_YAP1 <- readRDS(file = "Seurat_YAP_24.rds")
```
...
Day16_Control_YAP1 <- readRDS("Day16_Control_YAP1_processed.rds")
...
FeaturePlot_1 <-  FeaturePlot(seurat_Day16_Control_YAP1, c( "WLS","GBX2","STMN2","SOX10","PAX3","PAX7","SIX3","HESX1"),  pt.size = 0.2, cols = c("lightgrey",colorRampPalette(c("skyblue","turquoise4" ,"midnightblue"))(50)), order=T, ncol = 8)& NoAxes() &NoLegend()

...
FeaturePlot_regions <-  FeaturePlot(Timecourse, c("SOX2","NRG1","OTX2","FOXG1","FEZF1","RSPO3","SIX6","SFRP2"), ncol=8, pt.size = 0.3, cols = c("lightgrey",colorRampPalette(c("lightgrey","skyblue","midnightblue"))(30)), order=T) & NoAxes() & NoLegend()
